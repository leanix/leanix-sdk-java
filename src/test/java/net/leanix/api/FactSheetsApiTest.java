...
public class FactSheetsApiTest {
     ...
     */
    @Test
    public void getFactSheetHierarchyTest() throws ApiException {
        String rootId = null;
        Integer pageSize = null;
        String cursor = null;
        FactSheetListResponse response = api.getFactSheetHierarchy(rootId, pageSize, cursor);
    ...
    public void getFactSheetsTest() throws ApiException {
        ...
        String relationTypes = null;
        String fields = null;
        Boolean archivedOnly = null;
        Integer pageSize = null;
        String cursor = null;
        Boolean permissions = null;
        Boolean completion = null;
        Boolean documents = null;
        FactSheetListResponse response = api.getFactSheets(type, relationTypes, fields, archivedOnly, pageSize, cursor, permissions, completion, documents);
