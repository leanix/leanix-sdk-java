...
public class FactSheet {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, displayName, fullName, type, tags, fields, relations, completion, createdAt, updatedAt, documents, approvedAt, status, level, qualitySealStatus, permissions, score, rev, naFields, subscriptions);
  }
