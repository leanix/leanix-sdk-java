...
public class FactSheet {
  ...
  private List<AccessControlEntity> permittedReadACL = new ArrayList<AccessControlEntity>();

  @JsonProperty("permittedWriteACL")
  private List<AccessControlEntity> permittedWriteACL = new ArrayList<AccessControlEntity>();
  ...
  **/
  ...
  public FactSheet permittedReadACL(List<AccessControlEntity> permittedReadACL) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<AccessControlEntity> getPermittedReadACL() {
    return permittedReadACL;
  }

  public void setPermittedReadACL(List<AccessControlEntity> permittedReadACL) {
    this.permittedReadACL = permittedReadACL;
  }

  public FactSheet permittedWriteACL(List<AccessControlEntity> permittedWriteACL) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<AccessControlEntity> getPermittedWriteACL() {
    return permittedWriteACL;
  }

  public void setPermittedWriteACL(List<AccessControlEntity> permittedWriteACL) {
    this.permittedWriteACL = permittedWriteACL;
  }
