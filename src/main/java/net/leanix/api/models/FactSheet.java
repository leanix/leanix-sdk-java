...
import net.leanix.api.models.AccessControlEntityReference;
...
=======
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, displayName, fullName, type, tags, fields, relations, completion, createdAt, updatedAt, documents, approvedAt, status, permittedReadACL, permittedWriteACL, qualitySealStatus, score, level, permissions, rev, naFields, subscriptions);
  }
>>>>>>> release/3.9.30
    ...
    public int hashCode() {
        return Objects
            .hash(id, name, description, displayName, fullName, type, tags, fields, relations, completion, createdAt, updatedAt,
                documents, approvedAt, status, permittedReadACL, permittedWriteACL, qualitySealStatus, score, permissions, level,
                rev, naFields, subscriptions);
    }
