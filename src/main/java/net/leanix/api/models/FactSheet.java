...
public class FactSheet {
  ...
  private List<UUID> relationIds = new ArrayList<UUID>();
  ...
  **/
  ...
  public FactSheet relationIds(List<UUID> relationIds) {
    this.relationIds = relationIds;
    return this;
  }

  public FactSheet addRelationIdsItem(UUID relationIdsItem) {
