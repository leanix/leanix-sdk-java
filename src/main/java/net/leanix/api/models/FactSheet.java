...
public class FactSheet {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, displayName, fullName, type, tags, fields, relations, completion, createdAt, updatedAt, documents, approvedAt, status, permissions, level, score, permittedReadACL, permittedWriteACL, qualitySealStatus, rev, naFields, subscriptions);
  }
