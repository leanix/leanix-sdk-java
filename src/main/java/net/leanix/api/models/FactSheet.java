...
import net.leanix.api.models.Comment;
...
public class FactSheet {
  ...
  **/
  ...
  public FactSheet updatedAt(Instant updatedAt) {
  ...
  **/
  ...
  public FactSheet comments(List<Comment> comments) {
    this.comments = comments;
    return this;
  }

  public FactSheet addCommentsItem(Comment commentsItem) {
  ...
  **/
  ...
  public FactSheet approvedAt(Instant approvedAt) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, displayName, fullName, type, tags, fields, relations, completion, updatedAt, comments, approvedAt, status, level, qualitySealStatus, permissions, rev, naFields, subscriptions);
  }
