...
public class RelationListResponse {
  ...
  @JsonProperty("data")
  private List<FactSheetDataRelation> data = new ArrayList<FactSheetDataRelation>();
  ...
  **/
  ...
  public RelationListResponse data(List<FactSheetDataRelation> data) {
    this.data = data;
    return this;
  }

  public RelationListResponse addDataItem(FactSheetDataRelation dataItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<FactSheetDataRelation> getData() {
    return data;
  }

  public void setData(List<FactSheetDataRelation> data) {
    this.data = data;
  }
