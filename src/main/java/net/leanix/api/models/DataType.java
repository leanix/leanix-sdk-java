...
@JsonSubTypes({
  @JsonSubTypes.Type(value = StatusType.class, name = "StatusType"),
  @JsonSubTypes.Type(value = IntNumberDataType.class, name = "IntNumberDataType"),
  @JsonSubTypes.Type(value = MultiStringType.class, name = "MultiStringType"),
  ...
  @JsonSubTypes.Type(value = ClassificationType.class, name = "ClassificationType"),
