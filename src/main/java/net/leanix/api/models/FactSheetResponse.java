...
public class FactSheetResponse {
  ...
  @JsonProperty("data")
  private FactSheetData data = null;
  ...
  public FactSheetResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public FactSheetResponse data(FactSheetData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public FactSheetData getData() {
    return data;
  }

  public void setData(FactSheetData data) {
    this.data = data;
  }
