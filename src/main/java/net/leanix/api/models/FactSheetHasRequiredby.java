...
public class FactSheetHasRequiredby   {
  ...
  /**
   **/
  public FactSheetHasRequiredby ID(String ID) {
    this.ID = ID;
    return this;
  }
  ...
  /**
   **/
  public FactSheetHasRequiredby factSheetID(String factSheetID) {
  ...
  /**
   **/
  public FactSheetHasRequiredby factSheetRefID(String factSheetRefID) {
  ...
  /**
   **/
  public FactSheetHasRequiredby description(String description) {
  ...
  /**
   **/
  public FactSheetHasRequiredby dependencyTypeID(String dependencyTypeID) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FactSheetHasRequiredby factSheetHasRequiredby = (FactSheetHasRequiredby) o;
    return Objects.equals(this.ID, factSheetHasRequiredby.ID) &&
        Objects.equals(this.factSheetID, factSheetHasRequiredby.factSheetID) &&
        Objects.equals(this.factSheetRefID, factSheetHasRequiredby.factSheetRefID) &&
        Objects.equals(this.description, factSheetHasRequiredby.description) &&
        Objects.equals(this.dependencyTypeID, factSheetHasRequiredby.dependencyTypeID);
  }
