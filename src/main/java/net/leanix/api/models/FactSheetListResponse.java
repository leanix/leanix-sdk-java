...
public class FactSheetListResponse {
  ...
  @JsonProperty("data")
  private List<FactSheetData> data = new ArrayList<FactSheetData>();
  ...
  **/
  ...
  public FactSheetListResponse data(List<FactSheetData> data) {
    this.data = data;
    return this;
  }

  public FactSheetListResponse addDataItem(FactSheetData dataItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<FactSheetData> getData() {
    return data;
  }

  public void setData(List<FactSheetData> data) {
    this.data = data;
  }
