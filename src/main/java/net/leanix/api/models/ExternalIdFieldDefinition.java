...
public class ExternalIdFieldDefinition {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quickSearch, fullTextSearch, urlTemplate, uniqueFactSheet, autoIncrement, autoIncrementPrefix, autoIncrementMinLength, readOnly, forFactSheets, validators);
  }
