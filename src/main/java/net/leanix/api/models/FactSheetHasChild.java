...
public class FactSheetHasChild   {
  ...
  /**
   **/
  public FactSheetHasChild ID(String ID) {
    this.ID = ID;
    return this;
  }
  ...
  /**
   **/
  public FactSheetHasChild factSheetID(String factSheetID) {
  ...
  /**
   **/
  public FactSheetHasChild factSheetRefID(String factSheetRefID) {
  ...
  /**
   **/
  public FactSheetHasChild description(String description) {
  ...
  /**
   **/
  public FactSheetHasChild dependencyTypeID(String dependencyTypeID) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FactSheetHasChild factSheetHasChild = (FactSheetHasChild) o;
    return Objects.equals(this.ID, factSheetHasChild.ID) &&
        Objects.equals(this.factSheetID, factSheetHasChild.factSheetID) &&
        Objects.equals(this.factSheetRefID, factSheetHasChild.factSheetRefID) &&
        Objects.equals(this.description, factSheetHasChild.description) &&
        Objects.equals(this.dependencyTypeID, factSheetHasChild.dependencyTypeID);
  }
