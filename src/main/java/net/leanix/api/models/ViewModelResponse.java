...
public class ViewModelResponse {
  ...
  @JsonProperty("data")
  private ViewModelDefinition data = null;
  ...
  **/
  ...
  public ViewModelResponse data(ViewModelDefinition data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public ViewModelDefinition getData() {
    return data;
  }

  public void setData(ViewModelDefinition data) {
    this.data = data;
  }
