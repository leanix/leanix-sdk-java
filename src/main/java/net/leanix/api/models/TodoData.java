...
@JsonSubTypes({
  @JsonSubTypes.Type(value = InactiveUser.class, name = "InactiveUser"),
  @JsonSubTypes.Type(value = OpenComment.class, name = "OpenComment"),
  @JsonSubTypes.Type(value = SurveyResponse.class, name = "SurveyResponse"),
  @JsonSubTypes.Type(value = FactSheet.class, name = "FactSheet"),
})
...
public class TodoData {
  ...
  **/
  ...
  public TodoData dueDate(LocalDate dueDate) {
