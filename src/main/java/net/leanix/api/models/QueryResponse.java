...
public class QueryResponse   {
  ...
  private SavedQuery data = null;

  
  /**
   **/
  public QueryResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public QueryResponse errors(List<ApiError> errors) {
    this.errors = errors;
    return this;
  }
  ...
  /**
   **/
  public QueryResponse total(Long total) {
    this.total = total;
    return this;
  }
  ...
  /**
   **/
  public QueryResponse data(SavedQuery data) {
    this.data = data;
    return this;
  }
  ...
  @ApiModelProperty(example = "null", value = "")
  @JsonProperty("data")
  public SavedQuery getData() {
    return data;
  }
  public void setData(SavedQuery data) {
    this.data = data;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, queryResponse.status) &&
        ...
        Objects.equals(this.total, queryResponse.total) &&
