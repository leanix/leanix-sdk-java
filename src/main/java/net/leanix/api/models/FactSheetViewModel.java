...
public class FactSheetViewModel {
  ...
  private Map<String, List<String>> factSheetTabRestriction = new HashMap<String, List<String>>();
  ...
  **/
  ...
  public FactSheetViewModel facetViewStates(List<FacetViewState> facetViewStates) {
    this.facetViewStates = facetViewStates;
    return this;
  }

  public FactSheetViewModel addFacetViewStatesItem(FacetViewState facetViewStatesItem) {
...
>>>>>>> release/3.9.30
  ...
  public FactSheetViewModel factSheetTabRestriction(Map<String, List<String>> factSheetTabRestriction) {
    this.factSheetTabRestriction = factSheetTabRestriction;
    return this;
  }

  public FactSheetViewModel putFactSheetTabRestrictionItem(String key, List<String> factSheetTabRestrictionItem) {
    this.factSheetTabRestriction.put(key, factSheetTabRestrictionItem);
    return this;
  }

   /**
   * Get factSheetTabRestriction
   * @return factSheetTabRestriction
  **/
  @ApiModelProperty(example = "null", value = "")
  ...
  public void setFactSheetTabRestriction(Map<String, List<String>> factSheetTabRestriction) {
    this.factSheetTabRestriction = factSheetTabRestriction;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, factSheetViewModel.type) &&
        ...
        Objects.equals(this.facetViewStates, factSheetViewModel.facetViewStates) &&
        Objects.equals(this.sections, factSheetViewModel.sections) &&
        Objects.equals(this.hoverConfig, factSheetViewModel.hoverConfig) &&
        Objects.equals(this.factSheetTabRestriction, factSheetViewModel.factSheetTabRestriction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, bgColor, color, onTheFlyCreation, fieldMetaData, facetViewStates, sections, hoverConfig, factSheetTabRestriction);
  }
